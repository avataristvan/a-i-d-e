...
class Context:
    ...
    def __init__(self,
                 ...
                 strategy_provider: StrategyProviderPort | None = None):
        ...
        if strategy_provider:
            self.register(StrategyProviderPort, strategy_provider)
        else:
            self.register(StrategyProviderPort, StrategyProvider())
    ...
    @property
    def strategy_provider(self) -> StrategyProviderPort:
        return self.resolve(StrategyProviderPort)
